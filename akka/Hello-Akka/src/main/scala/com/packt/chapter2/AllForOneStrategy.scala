...
/**
  * Created by vladyslav.bachurin on 8/21/2017.
  */
...
class AllForOneStrategy extends Actor {
  override val supervisorStrategy = AllForOneStrategy(maxNrOfRetries = 10, withinTimeRange = 1 second) {
...
object AllForOneStrategyApp extends App {
  ...
  val supervisor = system.actorOf(Props[AllForOneStrategy], "suoervisor")
  supervisor ! "Start"
}
