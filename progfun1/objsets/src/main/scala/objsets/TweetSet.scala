...
abstract class TweetSet {
   ...
   */
    ...
    def mostRetweeted(currMax: Tweet): Tweet
...
class Empty extends TweetSet {
  ...
  def mostRetweeted(currMax: Tweet) = currMax
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  override def mostRetweeted = mostRetweeted(new Tweet("", "", 0))

  def mostRetweeted(currMax: Tweet): Tweet = {
    right.mostRetweeted(left.mostRetweeted(if (elem.retweets > currMax.retweets) elem else currMax))
  }
